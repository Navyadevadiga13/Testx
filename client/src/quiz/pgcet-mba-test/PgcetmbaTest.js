...
import PGCET_CONFIG from "./PgcetmbaConfig";
import pgcetmbaComputerAwareness from "./PgcetmbaComputerAwareness";
import pgcetmbaAnalyticalReasoning from "./PgcetmbaAnalyticalReasoning";
import pgcetmbaQuantitativeAnalysis from "./PgcetmbaQuantitativeAnalysis";
import pgcetmbaEnglishLanguage from "./PgcetmbaEnglishLanguage";
import pgcetmbaGeneralKnowledge from "./PgcetmbaGeneralKnowledge";
 

const DATA_MAP = {
  computerAwareness: pgcetmbaComputerAwareness,
  analyticalReasoning: pgcetmbaAnalyticalReasoning,
  quantitativeAnalysis: pgcetmbaQuantitativeAnalysis,
  englishLanguage: pgcetmbaEnglishLanguage,
  generalKnowledge: pgcetmbaGeneralKnowledge
};
...
export default function Pgcetmbatest() {
  ...
  const saveTestResult = async (finalScore, breakdown) => {
    ...
    try {
      ...
      console.log("PGCET MBA result saved:", data);
    } catch (err) {
      ...
      <div className="pgcet-result-container">
        ...
        <div className="result-card">
          ...
          <p className="result-sub">
            Your PGCET MBA mock test has been submitted and saved.
          </p>
